...
int main(){
    ...
    if(!(B7 & 0x1)){
			S7();
			S1();
			Pattern1(); wait(1); Pattern1(); wait(1);
      S2();
			Pattern2(); wait(1); Pattern2(); wait(1);
      S3();
			Pattern3(); wait(1); Pattern3(); wait(1);
      S4();
			Pattern4(); wait(1); Pattern4(); wait(1);
      S5();
			Pattern5(); wait(1); Pattern5(); wait(1);
      S6();
